...
main(int argc, char **argv)
{
  ...
  typename boost::property_map<cpad::graph, boost::vertex_data_t>::type vertexmap = get(vertex_data, g);
  typename boost::property_map<cpad::graph, boost::edge_data_t>::type edgemap = get(edge_data, g);
